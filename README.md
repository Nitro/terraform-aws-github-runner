...
- Linux vs Windows vs Mac. you can configure the OS types linux, win and mac. Linux will be used by default.
...
| <a name="input_instance_types"></a> [instance\_types](#input\_instance\_types) | List of instance types for the action runner. Defaults are based on runner\_os (amzn2 for linux, Windows Server Core for win and Mac ).                                                                                                                                                                                        | `list(string)` | <pre>[<br>  "m5.large",<br>  "c5.large"<br>]</pre> | no |
...
| <a name="input_runner_os"></a> [runner\_os](#input\_runner\_os) | The EC2 Operating System type to use for action runner instances (linux,windows,mac).                                                                                                                                                                                                                                          | `string` | `"linux"` | no |
